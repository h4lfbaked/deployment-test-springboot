pipeline {
    ...
    tools {
        maven 'Maven-3.9' // Pastikan nama ini sesuai dengan konfigurasi Maven di Jenkins Global Tool Configuration
    ...
    environment {
        ...
        DOCKER_CREDENTIALS_ID = 'docker-hub-credentials' // ID credentials di Jenkins
